...
/** Coin bar — top center */
export const COIN_BAR = { x: 404, y: 40, w: 235, h: 59 };
...
export const ANSWER_D = { x: 183, y: 1290, w: 525, h: 91 };
...
export const GLOW_A = { cx: 135, cy: 1040, r: 35 };
export const GLOW_B = { cx: 135, cy: 1147, r: 35 };
export const GLOW_C = { cx: 135, cy: 1250, r: 35 };
export const GLOW_D = { cx: 135, cy: 1365, r: 35 };

/** Option glow buttons — capsule shape behind answer options */
export const OPT_GLOW_A = { x: 76, y: 995, w: 690, h: 93 };
export const OPT_GLOW_B = { x: 76, y: 1100, w: 690, h: 93 };
export const OPT_GLOW_C = { x: 76, y: 1205, w: 690, h: 93 };
export const OPT_GLOW_D = { x: 76, y: 1316, w: 690, h: 93 };
